...
import 'package:shop_app/product/product_details.dart';
import 'package:shop_app/home/wrapper.dart';
...
String? userEmail;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamProvider<currentusername>.value(
          value: DatabaseService().current,
          initialData: new currentusername(uid: '0', n: 'Sign in please'),
          child: Scaffold(
      appBar: AppBar(
